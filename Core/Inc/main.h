...
#define Steering_PWM2_Pin GPIO_PIN_4
#define Steering_PWM2_GPIO_Port GPIOA
#define Steering_PWM1_Pin GPIO_PIN_6
#define Steering_PWM1_GPIO_Port GPIOA
#define Steering_PWM3_Pin GPIO_PIN_0
